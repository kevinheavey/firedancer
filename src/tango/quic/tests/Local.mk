...
$(call make-unit-test,test_quic_hs,test_quic_hs,fd_aio fd_quic fd_tls fd_ballet fd_tango fd_util)
$(call make-unit-test,test_quic_streams,test_quic_streams,fd_aio fd_tls fd_ballet fd_tango fd_quic fd_util)
$(call make-unit-test,test_quic_conn,test_quic_conn,fd_aio fd_quic fd_tls fd_ballet fd_tango fd_util)
$(call make-unit-test,test_quic_drops,test_quic_drops,fd_aio fd_quic fd_tls fd_ballet fd_tango fd_util fd_fibre)
$(call make-unit-test,test_quic_server,test_quic_server,fd_aio fd_tls fd_ballet fd_quic fd_tango fd_util)
$(call make-unit-test,test_quic_client_flood,test_quic_client_flood,fd_aio fd_tls fd_quic fd_ballet fd_tango fd_util)
$(call make-unit-test,test_quic_txn,test_quic_txn,fd_aio fd_quic fd_tls fd_ballet fd_tango fd_util)
$(call make-unit-test,test_quic_bw,test_quic_bw,fd_aio fd_quic fd_tls fd_ballet fd_tango fd_util)
$(call make-unit-test,test_quic_handshake,test_handshake,fd_aio fd_tls fd_ballet fd_quic fd_util)
$(call make-unit-test,test_quic_crypto,test_crypto,fd_quic fd_tls fd_ballet fd_util)
