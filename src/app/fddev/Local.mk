...
.PHONY: fddev
$(call make-bin-rust,fddev,main dev dev1 txn configure/netns configure/genesis,fd_fdctl fd_frank fd_disco fd_quic fd_tls fd_ballet fd_tango fd_util solana_validator_fd)
